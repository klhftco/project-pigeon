...
class DroneControllerOwl:
    """Manages drone connection, control, and integrates tracking with OWL-ViT."""

    def __init__(self, 
                 model_path="google/owlvit-base-patch32", 
                 conf_threshold=0.05,  # Lower threshold for OWL-ViT
                 iou_threshold=0.3,
                 max_track_age=5,
                 min_track_hits=3,
        ...
        """
        Initializes the drone controller with OWL-ViT detection, tracker, and control parameters.
        """
        logging.info("Initializing DroneControllerOwl...")
        self.tello = Tello()
        self.detector = OwlDetector(model_path=model_path)
        ...
        self.window_name = "Owl-ViT Drone Tracker"
        ...
        try:
            while True:
                ...
                if self.frame_skip_counter % 2 != 0: # Process odd frames (1, 3, 5...)
                    ...
                    # 2. Detect Objects using OWL-ViT
...
if __name__ == '__main__':
    ...
    # and run using: python -m drone_tracker.drone_controller_owl
    controller = DroneControllerOwl(
        model_path="google/owlvit-base-patch32",
        conf_threshold=0.05,  # Lower threshold to catch more potential matches
        iou_threshold=0.3,
